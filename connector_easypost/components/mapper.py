...
class EasypostImportMapper(AbstractComponent):

    _name = 'easypost.import.mapper'
    _inherit = ['base.easypost.connector', 'base.import.mapper']
...
class EasypostExportMapper(AbstractComponent):

    _name = 'easypost.export.mapper'
    _inherit = ['base.easypost.connector', 'base.export.mapper']
