...
class EasypostModelBinder(Component):
    ...
    _name = 'easypost.binder'
    _inherit = ['base.binder', 'base.easypost.connector']
    _apply_on = [
        'easypost.address',
        'easypost.parcel',
        'easypost.shipment',
    ...
    def unwrap_binding(self, binding_id, browse=False):
        ...
        Example: when called with a ``easypost.address`` id,
    ...
    def unwrap_model(self):
        ...
        Example: when called on a binder for ``easypost.address``,
